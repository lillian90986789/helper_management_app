...
const dict = {
  zh: {
    ...
    deleteList: '删除清单', deleteListConfirm: '清单将移入回收站，30 天内可恢复', itemPhoto: '参考图',
    trashBin: '回收站', restoreList: '恢复', deletedOn: '删除于', trashEmpty: '回收站是空的',
    photoCheckRule: 'AI 照片检查', photoCheckRuleHint: '可不填。女佣提交照片时 AI 按此规则自动检查，如：洗衣机洗的衣服里不能有内衣内裤',
    checkPassed: '检查通过', checkFailed: '未通过',
    maidReqTitle: '本周食材申请', maidReqHint: '每周五前提交，雇主周末统一处理', maidReqDeadline: '截止',
    maidReqAdd: '提交申请', maidReqName: '食材名称', maidReqEmpty: '本周还没有申请',
    reqPending: '待处理', reqToList: '已加入清单', reqOnline: '雇主线上购买', reqRejected: '未通过',
    reviewToList: '加入清单', reviewOnline: '线上买', withdraw: '撤回',
    ...
    awaitingSettle: '等待女佣提交结算',
    uploadAndSubmit: '上传小票并提交', scanHint: '拍摄小票照片，自动识别金额并逐项核对；漏买/多买会自动标记', adjustManually: '手动调整', simpleView: '简洁视图', reupload: '重拍',
    confirmRead: '确认已阅读',
    // meal order
  ...
  en: {
    ...
    deleteList: 'Delete list', deleteListConfirm: 'The list moves to trash and can be restored within 30 days', itemPhoto: 'Reference photo',
    trashBin: 'Trash', restoreList: 'Restore', deletedOn: 'Deleted', trashEmpty: 'Trash is empty',
    photoCheckRule: 'AI photo check', photoCheckRuleHint: 'Optional. AI checks submitted photos against this rule, e.g. no underwear in the washing machine load',
    checkPassed: 'Passed', checkFailed: 'Failed',
    maidReqTitle: 'My grocery requests (this week)', maidReqHint: 'Submit by Friday; employer reviews on the weekend', maidReqDeadline: 'Deadline',
    maidReqAdd: 'Submit', maidReqName: 'Item name', maidReqEmpty: 'No requests this week',
    reqPending: 'Pending', reqToList: 'Added to list', reqOnline: 'Employer buys online', reqRejected: 'Declined',
    reviewToList: 'Add to list', reviewOnline: 'Buy online', withdraw: 'Withdraw',
    ...
    awaitingSettle: 'Waiting for helper to submit settlement',
    uploadAndSubmit: 'Upload receipt & submit', scanHint: 'Snap the receipt — amounts are recognized and matched item by item; missed/extra items flagged automatically', adjustManually: 'Adjust manually', simpleView: 'Simple view', reupload: 'Retake',
